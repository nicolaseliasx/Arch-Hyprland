...
<reference>
@/home/ncls/.config/opencode/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/ncls/.config/opencode/gsd-core/references/user-profiling.md` to load:
