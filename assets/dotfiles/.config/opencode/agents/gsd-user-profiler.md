...
<reference>
@$HOME/.config/opencode/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `$HOME/.config/opencode/gsd-core/references/user-profiling.md` to load:
