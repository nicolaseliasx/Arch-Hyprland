...
Reference full template: `/home/ncls/.config/opencode/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/ncls/.config/opencode/gsd-core/templates/state.md`.
