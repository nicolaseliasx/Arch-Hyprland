...
```markdown
Read /home/ncls/.config/opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/ncls/.config/opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/ncls/.config/opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/ncls/.config/opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/ncls/.config/opencode/agents/gsd-eval-planner.md for instructions.
