...
```
Agent(
  prompt="Read /home/ncls/.config/opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/ncls/.config/opencode/gsd-core/templates/VALIDATION.md`
