...
ones). Reference: @/home/ncls/.config/opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/ncls/.config/opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/ncls/.config/opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/ncls/.config/opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/ncls/.config/opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/ncls/.config/opencode/gsd-core/templates/spec.md.
