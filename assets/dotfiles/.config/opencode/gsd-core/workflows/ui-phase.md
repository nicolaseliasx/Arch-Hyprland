...
```markdown
Read /home/ncls/.config/opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/ncls/.config/opencode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/ncls/.config/opencode/agents/gsd-ui-checker.md for instructions.
...
@/home/ncls/.config/opencode/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/ncls/.config/opencode.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/ncls/.config/opencode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/ncls/.config/opencode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
question — **Specify** (→ `resolved`, verification: explicit; write a concrete truth) / **Dismiss (reason required)** /
