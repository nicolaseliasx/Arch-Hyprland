...
Template: $HOME/.config/opencode/gsd-core/templates/UI-SPEC.md
</output>
...
@$HOME/.config/opencode/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / $HOME/.config/opencode.
...
UI_PROBE_JS=$(for _c in \
  ...
  "$HOME/.config/opencode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "$HOME/.config/opencode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
