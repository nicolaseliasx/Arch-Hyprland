...
Key references:
- @$HOME/.config/opencode/gsd-core/references/ui-brand.md (display patterns)
- @$HOME/.config/opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @$HOME/.config/opencode/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="$HOME/.config/opencode/gsd-core/USER-PROFILE.md"
...
```bash
cp "$HOME/.config/opencode/gsd-core/USER-PROFILE.md" "$HOME/.config/opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at $HOME/.config/opencode/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `$HOME/.config/opencode/gsd-core/references/user-profiling.md`
...
Reference: @$HOME/.config/opencode/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to $HOME/.config/opencode/gsd-core/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at $HOME/.config/opencode/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at $HOME/.config/opencode/skills/gsd-dev-preferences/SKILL.md"
...
Your profile:    $HOME/.config/opencode/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   $HOME/.config/opencode/skills/gsd-dev-preferences/SKILL.md
