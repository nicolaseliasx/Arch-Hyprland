...
<!-- For checkpoint task examples and patterns, see @$HOME/.config/opencode/gsd-core/references/checkpoints.md -->
...
See `$HOME/.config/opencode/gsd-core/references/tdd.md` for TDD plan structure.
...
See `$HOME/.config/opencode/gsd-core/templates/user-setup.md` for full schema and examples
...
See `$HOME/.config/opencode/gsd-core/workflows/verify-phase.md` for verification logic.
