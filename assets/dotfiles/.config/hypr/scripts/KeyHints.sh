...
"" "" "" \
"Right Ctrl" "Toggle Special Workspace" "(Scratchpad)" \
" Right Ctrl" "Set Split Ratio 35%" "(layoutmsg)" \
" SHIFT Right Ctrl" "Move to Special Workspace" "(movetoworkspace)" \
" SHIFT V" "Vertical Split DP-2" "(DP2ColumnLayout.py)"
