...
toggle_mute() {
	if [ "$(pamixer --get-mute)" == "false" ]; then
		pamixer -m && notify-send -e -u low -h boolean:SWAYNC_BYPASS_DND:true "volume" " muted"
	elif [ "$(pamixer --get-mute)" == "true" ]; then
		pamixer -u && notify-send -e -u low -h int:value:"$(pamixer --get-volume)" -h boolean:SWAYNC_BYPASS_DND:true "volume" " $(pamixer --get-volume)%"
	fi
}
...
toggle_mic() {
	if [ "$(pamixer --default-source --get-mute)" == "false" ]; then
		pamixer --default-source -m && notify-send -e -u low -h boolean:SWAYNC_BYPASS_DND:true "mic volume" " switched off"
	elif [ "$(pamixer --default-source --get-mute)" == "true" ]; then
		pamixer --default-source -u && notify-send -e -u low -h boolean:SWAYNC_BYPASS_DND:true "mic volume" " switched on"
	fi
}
# Get Mic Icon
get_mic_icon() {
