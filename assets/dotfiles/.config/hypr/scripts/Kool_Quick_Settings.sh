...
main() {
    ...
    case "$choice" in
    	"Edit User Defaults") file="$HOME/.config/hypr/config/apps.lua" ;;
        "Edit User ENV variables") file="$HOME/.config/hypr/config/environment.lua" ;;
        "Edit User Keybinds") file="$HOME/.config/hypr/config/bindings.lua" ;;
        "Edit User Startup Apps (overlay)") file="$HOME/.config/hypr/config/autostart.lua" ;;
        "Edit User Window Rules (overlay)") file="$HOME/.config/hypr/config/rules.lua" ;;
        "Edit User Settings"|"Edit User Decorations"|"Edit System Default Settings") file="$HOME/.config/hypr/config/settings.lua" ;;
        "Edit User Animations") file="$HOME/.config/hypr/config/animations.lua" ;;
        "Edit User Laptop Settings") file="$HOME/.config/hypr/config/devices.lua" ;;
        "Edit System Default Keybinds") file="$HOME/.config/hypr/config/bindings.lua" ;;
        "Edit System Default Startup Apps") file="$HOME/.config/hypr/config/autostart.lua" ;;
        "Edit System Default Window Rules") file="$HOME/.config/hypr/config/rules.lua" ;;
