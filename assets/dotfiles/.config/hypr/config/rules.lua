...
hl.window_rule({match = {class = "^([Ww]hatsapp-for-linux|ZapZap|com.rtosta.zapzap)$"}, name = "Whatsapp-zapzap", size = "(monitor_w*0.6) (monitor_h*0.7)", center = true})
hl.window_rule({match = {title = "^(Picture-in-Picture)$"}, name = "Picture-in-Picture", float = true, move = "72% 7%", opacity = "0.95 0.75", pin = true, keep_aspect_ratio = true, size = "(monitor_w*0.3) (monitor_h*0.3)"})
hl.window_rule({match = {class = "^(thunar)$", title = "^(File Operation Progress)$"}, name = "Thunar-Progress-bar", float = true, center = true, size = "(monitor_w*0.26) (monitor_h*0.18)"})
hl.window_rule({match = {class = "^([Ff]irefox|org.mozilla.firefox|[Ff]irefox-esr|[Ff]irefox-bin)$"}, workspace = "1 silent"})
hl.window_rule({match = {class = "^(Zed|dev\\\\.zed\\\\.Zed)$"}, workspace = "2 silent"})
hl.window_rule({match = {class = "^([Ss]lack)$"}, workspace = "9 silent"})
hl.window_rule({match = {class = "^([Ss]potify|spotify)$"}, workspace = "special:special silent"})
hl.window_rule({match = {class = "^(kitty-boot-bottom)$"}, workspace = "9 silent"})
hl.window_rule({match = {tag = "browser"}, opacity = "1.0 override 1.0 override 1.0 override"})
hl.window_rule({match = {tag = "browser"}, no_dim = true})
hl.window_rule({match = {tag = "projects"}, opacity = "1.0 override 1.0 override 1.0 override"})
hl.window_rule({match = {tag = "projects"}, no_dim = true})
hl.window_rule({match = {class = "^(Slack)$"}, opacity = "1.0 override 1.0 override 1.0 override"})
hl.window_rule({match = {class = "^(Slack)$"}, no_dim = true})
hl.window_rule({match = {class = "^([Ss]potify|spotify)$"}, opacity = "1.0 override 1.0 override 1.0 override"})
hl.window_rule({match = {class = "^([Ss]potify|spotify)$"}, no_dim = true})
hl.window_rule({match = {class = "^(discord)$"}, opacity = "1.0 override 1.0 override 1.0 override"})
hl.window_rule({match = {class = "^([Ss]tremio.*)$"}, opaque = true})
hl.window_rule({match = {class = "^([Ss]tremio.*)$"}, no_dim = true})
hl.window_rule({match = {class = "^([Cc]ursor|cursor|Windsurf|windsurf|Zed|dev\\\\.zed\\\\.Zed|com\\\\.google\\\\.AndroidStudio)$"}, opacity = "1.0 override 1.0 override 1.0 override"})
hl.window_rule({match = {class = "^([Cc]ursor|cursor|Windsurf|windsurf|Zed|dev\\\\.zed\\\\.Zed|com\\\\.google\\\\.AndroidStudio)$"}, no_dim = true})
hl.window_rule({match = {tag = "terminal"}, opacity = "1.0 override 0.98 override 1.0 override"})
hl.window_rule({match = {tag = "terminal"}, no_blur = true})
hl.window_rule({match = {class = "^(kitty)$"}, animation = "popin 88%"})
hl.window_rule({match = {class = "^(system-update)$"}, float = true, size = "(monitor_w*0.45) (monitor_h*0.6)", center = true})
